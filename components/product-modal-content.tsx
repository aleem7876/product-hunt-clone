...
const ProductModalContent: React.FC<ProductModalContentProps> = ({
  ...
  const handleDeleteComment = async (commentId: string) => {
    try {
      // Call the delete comment function with the commentID
      await deleteComment(commentId);
      // Filter out the delete comment from the comments state
  ...
  const handleUpvoteClick = async (
    ...
    try {
      ...
      // Handle error appropriately, eg., display an error message to the user
    }
  }
        ...
        <div className="py-4 space-y-2">
          ...
          <div className="md:flex md:justify-between items-center">
            ...
            <div className="flex items-center gap-2 pt-4">
              ...
              <button
                className={`rounded-md flex items-center justify-center p-5 gap-x-3 cursor-pointer bg-gradient-to-r w-full xl:w-56 ${
                  hasUpvoted
            ...
            <div>
              <div className="w-full flex gap-4 mt-4">
                ...
                <textarea
                  ...
                  className="w-full border rounded-md p-4 focus:outline-none text-gray-600 border-none"
                />
              </div>
              ...
              >
                <button className="bg-[#ff6154] text-white p-2 rounded-md">
                  Comment
                </button>
              </div>
            </div>
                    ...
                    <div className="flex justify-between items-center">
                      <div className="flex gap-x-2 items-center">
                        ...
                        {comment.userId === currentProduct.userId && (
                          <Badge className="bg-[#88aaff]">Creater</Badge>
                        )}
