...
import { getActiveProducts, getAdminData, getPendingProducts, getRejectedProducts, getTotalUpvotes, getUsers } from "@/lib/server-actions";
        ...
        <div className="flex justify-between items-center">
          <div className="flex gap-x-6 items-center py-10">
            ...
            <div className="hidden md:block">
              ...
              <p>Here is what&apos;s happening in your business today</p>
            </div>
          </div>
