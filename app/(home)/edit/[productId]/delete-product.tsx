...
const DeleteProduct: React.FC<DeleteProductProps> = ({ productId }) => {
  ...
  return (
    <>
      ...
      >
        <div>
          <PiStorefront className="text-red-500 text-5xl mb-10 bg-red-100 p-1 rounded-md" />
          <h1 className="text-xl font-semibold mb-10">Delete Product</h1>
          <p className="text-sm">
            We&apso;re sorry to see you go. Once your product is deleted, all
            your content will be permanently gone, including your product and
            product settings.
          </p>
          <p className="text-sm py-10">
            This action can not be undone. This will permanently delete your
            product and all your content.
          </p>
